...
// Java 객체 : new 연산자의 의해 Heap 영역에
//             클래스에 작성된 내용대로 생성된 것

// instance : 개발자가 집적 만들고, 관리 하는 객체
...
public class TestController {
	...
	*/
	...
	// 2) 클래스에 작성
	// - 공통 주소를 매핑
	// ex) /todo/insert, todo/selct, /todo/update...
	...
	public String testMethod() {		
		 ...
		 * - 메서드에서 반환되는 문자열이
		 * 	 forward 할 html 파일의 경로가 있기 때문
		 * 
		 * Thymelift : JSP 대신 사용하는 템플릿 엔진(html 형태)
		 * 
