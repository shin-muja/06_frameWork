...
@Controller // 요청 / 응답 제어 역할을 명시 + Bean 등록
...
public class ParameterController {
	 ...
	 * - 매개변수 앞에 해상 어노테이션을 작성하면, 매개변수에 값이 주입됨
	 ...
	 * 
	 * [속성 추가 작성법]
	 * @RequstParam(value="name", required="false", defaultValue="1")
	 * 
	 * value : 전달받은 input 태그의 name 속성값(파라미터 key)
	 * 
	 * required : 입력된 name 속성값 파라미터 필수 여부 지정(기본값 true)
	 * -> required = true인 파라미터가 존재하지 않는다면 400 Bad Request 에러발생
	 * 
	...
	public String paramTest3( @RequestParam("color") String[] colorArr,
		...
		// {color=Blue, fruit=Apple, productName=아름다운조명, expirationDate=2024-10-08}
	...
	public String paramTest4(/*@ModelAttribute*/ MemberDTO inputMember) {
							//	-> 커맨드 객체
							// @ModelAttribute 생략 가능 주의사항과 같이 name 속성명이 DTO의 필드명과 같고
							//                 기본 생성자 setter가 존재한다면 똑같이 작동된다
