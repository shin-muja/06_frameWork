...
=======
			 ...
			 '암호화된 비밀번호',
			 '유저7',
>>>>>>> 68ca6c524295b097088f9babf8c84fb1b8eb8b13
			 '01012341234',
			 NULL,
			 NULL,
			 DEFAULT,
...
UPDATE  "MEMBER" SET
<<<<<<< HEAD
"MEMBER_PW" = '$2y$10$FRWe1/mYDZb59fzTpH8Jm./8BYgU97GWaKYFFMCKzuhqqDgd/iemC'
WHERE "MEMBER_NO" = '3';
...
UPDATE "BOARD_TYPE" SET BOARD_NAME = '공지 게시판'
WHERE BOARD_CODE = 1;
...
SELECT * FROM "BOARD"; -- 존재하는 회원 중 하나로 진행
...
-- 번호 / 제목(댓글갯수) / 작성자 닉네임 / 작성일 / 조회수 / 좋아요 개수

SELECT BOARD_NO, BOARD_TITLE, MEMBER_NICKNAME, READ_COUNT,

	(SELECT COUNT(*) FROM "COMMENT" C
	WHERE C.BOARD_NO = B.BOARD_NO) COMMECT_COUNT,
...
(SELECT COUNT(*)
FROM "BOARD_LIKE"
WHERE BOARD_NO = 1999) LIKE_CHECK
...
VALUES(1, 1999); -- 1번 회원이 1998번 글에 좋아요를 클릭함
...
-- /myPage/profile/20241112152710_00002.jfif
...
GROUP BY BOARD_NAME, BOARD_NO, BOARD_TITLE, MEMBER_NICKNAME
HAVING COUNT(*)  = 

(SELECT MAX(COUNT(*)) FROM "BOARD_LIKE"
GROUP BY BOARD_NO)
...
LEFT JOIN "BOARD_TYPE" USING(BOARD_CODE)
LEFT JOIN "COMMENT" USING(BOARD_NO)
GROUP BY BOARD_NO, BOARD_NAME, BOARD_TITLE, MEMBER_NICKNAME
HAVING COUNT(*) = 
