...
public class FileConfig implements WebMvcConfigurer{
	...
	// WebMvcConfigurer : Spring MCV 프레임워크에서 제공하는 인터페이스 중 하나로,
	// 스크링 구성을 커스터마이징하고 확장하기 위한 메서드를 제공함
	...
	// MultipartResolber 객체를 생성하여 Bean으로 등록
	// -> Bean으로 등록하면서 위에서만든 MultipartConfigElement 자동으로 이용함
	@Bean
