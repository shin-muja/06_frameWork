...
public class LogginAspect {
	 ...
	 * @param jp
	 */
	@Before("PointupBundel.controllerPointCut()")
	public void beforeContoller(JoinPoint jp) {
		// JoinPoint와 같이 HttpServletRequest를 가져올 수 없다.
	 ...
	 * @throws Throwable 
	 */
	@Around("PointupBundel.serviceImplPointCut()")
	public Object aroundServiceImpl(ProceedingJoinPoint pjp) throws Throwable {
		...
		// @Before
		String className = pjp.getTarget().getClass().getSimpleName(); // ex) MainController, MemberController
