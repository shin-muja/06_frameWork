...
// JUnit
// Java 애플리케이션에서 테스트 코드를 작성하고 실행하기 위한 가장 널리
// 사용되는 테스트 프레임 워크
// 통합/단위 테스트 지원 : 각 메서드의 동작을 독립적으로 테스트 할 수 있는 환경을 제공
...
public class AppTest {
	...
	// BeforeAll, AfterAll 단점 : * static 메서드에서만 사용 가능 *
	@BeforeAll
